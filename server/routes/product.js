...
// controllers
const {getAllProducts,getSingleProduct,createProduct,updateProduct,deleteProduct,getProductPhoto,getTotalProductsLength, getProductByID} = require('../controllers/product')
